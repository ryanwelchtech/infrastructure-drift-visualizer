  ...
  'inline-flex items-center justify-center whitespace-nowrap rounded-xl text-sm font-semibold ring-offset-background transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50',
  {
    variants: {
      variant: {
        ...
        glass:
          'glass-button text-white hover:shadow-xl hover:-translate-y-0.5',
        success:
          'bg-drift-synced text-white hover:bg-drift-synced/90 hover:shadow-lg hover:-translate-y-0.5',
        warning:
          'bg-drift-modified text-black hover:bg-drift-modified/90 hover:shadow-lg hover:-translate-y-0.5',
        danger:
          'bg-drift-missing text-white hover:bg-drift-missing/90 hover:shadow-lg hover:-translate-y-0.5',
      },
      size: {
